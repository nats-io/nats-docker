...
docker cp $ID:/go/src/github.com/nats-io/nats-server/pkg/win-amd64/nats-server.exe windows/nanoserver-1803/
docker cp $ID:/go/src/github.com/nats-io/nats-server/pkg/win-amd64/nats-server.exe windows/nanoserver-1809/
